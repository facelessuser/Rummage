...
class SettingsDialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_re_radio = wx.RadioButton( self.m_search_panel, wx.ID_ANY, u"Use re module", wx.DefaultPosition, wx.DefaultSize, wx.RB_GROUP )
		...
		self.m_bre_radio = wx.RadioButton( self.m_search_panel, wx.ID_ANY, u"Use re module with backrefs", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer43.Add( self.m_bre_radio, 0, wx.ALL, 5 )
		
		
		fgSizer43.Add( ( 0, 0), 1, wx.EXPAND, 5 )
		
		self.m_regex_radio = wx.RadioButton( self.m_search_panel, wx.ID_ANY, u"Use regex module", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_bregex_radio = wx.RadioButton( self.m_search_panel, wx.ID_ANY, u"Use regex module with backrefs", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_regex_version_label = wx.StaticText( self.m_search_panel, wx.ID_ANY, u"Regex module version to use", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_regex_ver_choice = wx.Choice( self.m_search_panel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_regex_ver_choiceChoices, 0 )
