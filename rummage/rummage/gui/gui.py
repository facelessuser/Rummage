...
class RummageFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		sbSizer2 = wx.StaticBoxSizer( wx.StaticBox( self.m_search_panel, wx.ID_ANY, u"Search and Replace" ), wx.VERTICAL )
		...
		m_replace_textboxChoices = []
		self.m_replace_textbox = wx.ComboBox( self.m_search_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, m_replace_textboxChoices, wx.TE_PROCESS_ENTER )
		...
		self.m_size_text = wx.TextCtrl( self.m_limit_size_panel, wx.ID_ANY, u"1000", wx.DefaultPosition, wx.Size( -1,-1 ), 0 )
		...
		fgSizer4.Add( self.m_exclude_textbox, 1, wx.ALL|wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.m_dirregex_checkbox = wx.CheckBox( self.m_limit_panel, wx.ID_ANY, u"Regex", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer4.Add( self.m_dirregex_checkbox, 1, wx.ALIGN_CENTER_VERTICAL|wx.ALL|wx.EXPAND, 5 )
		...
		fgSizer4.Add( self.m_filematch_textbox, 1, wx.ALL|wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		fgSizer2.Add( self.m_progressbar, 1, wx.ALIGN_CENTER|wx.ALL|wx.EXPAND, 5 )
		...
		bActionSizer.Add( fgSizer38, 1, wx.EXPAND, 5 )
...
class RegexTestDialog ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Regex Tester", pos = wx.DefaultPosition, size = wx.Size( 500,475 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		sbSizer111 = wx.StaticBoxSizer( wx.StaticBox( self.m_tester_panel, wx.ID_ANY, u"Replace" ), wx.VERTICAL )
		...
		sbSizer9.Add( fgSizer39, 1, wx.EXPAND, 5 )
