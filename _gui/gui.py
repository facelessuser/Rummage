...
class RummageFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		fgSizer6.Add( fgSizer121, 0, wx.EXPAND, 5 )
		...
		self.m_searchfor_label = wx.StaticText( self.m_search_panel, wx.ID_ANY, u"What", wx.DefaultPosition, wx.DefaultSize, 0|wx.TAB_TRAVERSAL )
		...
		fgSizer9 = wx.FlexGridSizer( 2, 6, 0, 0 )
		fgSizer9.AddGrowableCol( 0 )
		fgSizer9.AddGrowableCol( 5 )
		...
		fgSizer35.Add( self.m_size_text, 0, wx.ALL, 5 )
		...
		fgSizer35.Add( self.m_size_type_label, 0, wx.ALIGN_CENTER_VERTICAL|wx.BOTTOM|wx.RIGHT|wx.TOP, 5 )
		
		
		fgSizer11.Add( fgSizer35, 1, wx.EXPAND, 5 )
		...
		fgSizer11.Add( self.m_modified_date_picker, 0, wx.ALL, 5 )
		...
		fgSizer11.Add( self.m_modified_time_picker, 0, wx.ALL, 5 )
		...
		fgSizer11.Add( self.m_created_time_picker, 0, wx.ALL, 5 )
...
class SettingsDialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Preferences", pos = wx.DefaultPosition, size = wx.Size( 350,-1 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		fgSizer35.Add( self.m_notify_choice, 0, wx.ALL, 5 )
		...
		self.m_history_label = wx.StaticText( self.m_settings_panel, wx.ID_ANY, u"0000 Records", wx.DefaultPosition, wx.DefaultSize, 0 )
