...
class RummageFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_searchin_label = wx.StaticText( self.m_search_panel, wx.ID_ANY, u"Where", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_searchin_label.Wrap( -1 )
		fgSizer8.Add( self.m_searchin_label, 1, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT|wx.ALL, 5 )
		
		m_searchin_textChoices = []
		self.m_searchin_text = wx.ComboBox( self.m_search_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, m_searchin_textChoices, wx.TE_PROCESS_ENTER|wx.TAB_TRAVERSAL )
		self.m_searchin_text.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), 70, 90, 90, False, wx.EmptyString ) )
		
		fgSizer8.Add( self.m_searchin_text, 1, wx.ALL|wx.EXPAND, 5 )
		...
		self.m_searchfor_label = wx.StaticText( self.m_search_panel, wx.ID_ANY, u"What", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_searchfor_label.Wrap( -1 )
		fgSizer8.Add( self.m_searchfor_label, 1, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT|wx.ALL, 5 )
		...
		fgSizer37.Add( self.m_utf8_checkbox, 0, wx.ALL, 5 )
		...
		fgSizer2.Add( self.m_search_panel, 1, wx.ALL|wx.EXPAND, 5 )
		...
		fgSizer11.Add( self.m_size_is_label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT|wx.ALL, 5 )
		...
		fgSizer11.Add( self.m_logic_choice, 1, wx.ALL|wx.EXPAND, 5 )
		
		self.m_size_text = wx.TextCtrl( self.m_limit_size_panel, wx.ID_ANY, u"1000", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer11.Add( self.m_size_text, 1, wx.ALL|wx.EXPAND, 5 )
		...
		fgSizer11.Add( self.m_size_type_label, 0, wx.ALIGN_CENTER_VERTICAL|wx.BOTTOM|wx.RIGHT|wx.TOP, 5 )
		...
		fgSizer11.Add( self.m_modified_label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT|wx.ALL, 5 )
		
		m_modified_choiceChoices = [ u"on any", u"after", u"on", u"before" ]
		self.m_modified_choice = wx.Choice( self.m_limit_size_panel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_modified_choiceChoices, 0 )
		self.m_modified_choice.SetSelection( 0 )
		fgSizer11.Add( self.m_modified_choice, 1, wx.ALL|wx.EXPAND, 5 )
		
		self.m_modified_date_picker = wx.DatePickerCtrl( self.m_limit_size_panel, wx.ID_ANY, wx.DefaultDateTime, wx.DefaultPosition, wx.DefaultSize, wx.DP_DROPDOWN )
		fgSizer11.Add( self.m_modified_date_picker, 1, wx.ALL, 5 )
		
		self.m_modified_time_picker = wx.TextCtrl( self.m_limit_size_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer11.Add( self.m_modified_time_picker, 1, wx.ALL, 5 )
		
		self.m_modified_spin = wx.SpinButton( self.m_limit_size_panel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer11.Add( self.m_modified_spin, 0, wx.BOTTOM|wx.RIGHT|wx.TOP, 5 )
		
		self.m_created_label = wx.StaticText( self.m_limit_size_panel, wx.ID_ANY, u"Created", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_created_label.Wrap( -1 )
		fgSizer11.Add( self.m_created_label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT|wx.ALL, 5 )
		
		m_created_choiceChoices = [ u"on any", u"after", u"on", u"before" ]
		self.m_created_choice = wx.Choice( self.m_limit_size_panel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_created_choiceChoices, 0 )
		self.m_created_choice.SetSelection( 0 )
		fgSizer11.Add( self.m_created_choice, 1, wx.ALL|wx.EXPAND, 5 )
		
		self.m_created_date_picker = wx.DatePickerCtrl( self.m_limit_size_panel, wx.ID_ANY, wx.DefaultDateTime, wx.DefaultPosition, wx.DefaultSize, wx.DP_DROPDOWN )
		fgSizer11.Add( self.m_created_date_picker, 1, wx.ALL, 5 )
		
		self.m_created_time_picker = wx.TextCtrl( self.m_limit_size_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer11.Add( self.m_created_time_picker, 1, wx.ALL, 5 )
		
		self.m_created_spin = wx.SpinButton( self.m_limit_size_panel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer11.Add( self.m_created_spin, 0, wx.BOTTOM|wx.RIGHT|wx.TOP, 5 )
		...
		self.m_exclude_textbox = wx.ComboBox( self.m_limit_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, m_exclude_textboxChoices, wx.TE_PROCESS_ENTER|wx.WANTS_CHARS )
		...
		self.m_filematch_textbox = wx.ComboBox( self.m_limit_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, m_filematch_textboxChoices, wx.TE_PROCESS_ENTER|wx.WANTS_CHARS )
		...
		self.m_hidden_checkbox = wx.CheckBox( self.m_limit_toggle_panel, wx.ID_ANY, u"Include hidden", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer32.Add( self.m_hidden_checkbox, 0, wx.ALL, 5 )
		
		self.m_binary_checkbox = wx.CheckBox( self.m_limit_toggle_panel, wx.ID_ANY, u"Include binary files", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_limit_toggle_panel.Layout()
		fgSizer32.Fit( self.m_limit_toggle_panel )
		fgSizer33.Add( self.m_limit_toggle_panel, 1, wx.EXPAND |wx.ALL, 5 )
		
		
		sbSizer4.Add( fgSizer33, 1, wx.EXPAND, 5 )
...
class RegexTestDialog ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		sbSizer11 = wx.StaticBoxSizer( wx.StaticBox( self.m_tester_panel, wx.ID_ANY, u"Text" ), wx.HORIZONTAL )
...
class SettingsDialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_debug_checkbox = wx.CheckBox( self.m_settings_panel, wx.ID_ANY, u"Enable debug level", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer36.Add( self.m_debug_checkbox, 0, wx.ALL, 5 )
		
		self.m_debug_button = wx.Button( self.m_settings_panel, wx.ID_ANY, u"Show Log", wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer36.Add( self.m_debug_button, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )
		
		
		sbSizer8.Add( fgSizer36, 1, wx.EXPAND, 5 )
		...
		self.m_debug_checkbox.Bind( wx.EVT_CHECKBOX, self.on_debug_toggle )
		self.m_debug_button.Bind( wx.EVT_BUTTON, self.on_show_log )
...
class EditorDialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Configure Editor", pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.DEFAULT_DIALOG_STYLE )
