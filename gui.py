...
class PyGrep ( wx.Frame ):
	
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Rummage", pos = wx.DefaultPosition, size = wx.Size( 771,394 ), style = wx.DEFAULT_FRAME_STYLE|wx.RESIZE_BORDER|wx.TAB_TRAVERSAL )
		...
		self.m_searchin_panel = wx.Panel( self.m_settings_panel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_searchin_text = wx.TextCtrl( self.m_searchin_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		fgSizer121.Add( self.m_searchin_dir_picker, 1, wx.ALL|wx.EXPAND, 5 )
		...
		self.m_search_panel = wx.Panel( self.m_settings_panel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_searchfor_textbox = wx.TextCtrl( self.m_search_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_searchfor_textbox.SetMaxLength( 0 ) 
		fgSizer8.Add( self.m_searchfor_textbox, 0, wx.ALL|wx.EXPAND, 5 )
		...
		self.m_regextest_button = wx.Button( self.m_search_panel, wx.ID_ANY, u"Test regex", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_regextest_button.Hide()
		
		fgSizer9.Add( self.m_regextest_button, 0, wx.ALL, 5 )
		...
		self.m_exclude_textbox = wx.TextCtrl( self.m_limit_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_exclude_textbox.SetMaxLength( 0 ) 
		...
		self.m_filematch_textbox = wx.TextCtrl( self.m_limit_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_filematch_textbox.SetMaxLength( 0 ) 
		fgSizer4.Add( self.m_filematch_textbox, 0, wx.ALL|wx.EXPAND, 5 )
		...
		self.m_searchin_text.Bind( wx.EVT_TEXT, self.on_searchin_changed )
