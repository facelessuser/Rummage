...
class RummageFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		fgSizer11.Add( self.m_modified_spin, 0, wx.BOTTOM|wx.RIGHT|wx.TOP|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		fgSizer11.Add( self.m_created_spin, 0, wx.BOTTOM|wx.RIGHT|wx.TOP|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		self.m_exclude_textbox = AutoCompleteCombo(self.m_limit_panel)
		...
		self.m_filematch_textbox = AutoCompleteCombo(self.m_limit_panel)
...
class SettingsDialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_regex_checkbox = wx.CheckBox( self.m_settings_panel, wx.ID_ANY, u"Use experimental regex module", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_regex_checkbox.Enable( False )
		
		fgSizer43.Add( self.m_regex_checkbox, 0, wx.ALL, 5 )
		...
		sbSizer8.Add( fgSizer43, 1, wx.EXPAND, 5 )
		...
		self.m_regex_checkbox.Bind( wx.EVT_CHECKBOX, self.on_regex_toggle )
